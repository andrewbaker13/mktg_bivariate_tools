...
const SENTIMENT_LAB_SCENARIOS = [
  {
    ...
    label: '\u{1F4AC} Reddit Posts: University Enrollment System',
    description: () => `
      <div class="scenario-card">
        <div class="scenario-header">
          <span class="scenario-icon">\u{1F4AC}</span>
          <h3>Reddit Posts: University Enrollment System Feedback</h3>
        </div>
        <div class="scenario-badge-row">
          <span class="badge badge-context">Social Media Analysis</span>
          <span class="badge badge-hypothesis">UX Feedback Mining</span>
          <span class="badge badge-sample">n = 30 posts</span>
        </div>
        <div class="scenario-body">
          <p><strong>Business Context:</strong> A Southern California university recently deployed a <strong>new online course enrollment system</strong> to replace their aging registration platform. The IT department and university administration want to assess early user reception before the next enrollment window. Simulated Reddit-style posts capture authentic student voices\u2014some praising the modern interface, others venting frustration about bugs, timeouts, and confusing waitlist logic.</p>
          
          <div class="context-grid">
            <div class="context-card">
              <span class="context-label">\u{1F4DD} Text Column</span>
              <span class="context-value"><code>text</code> (post content)</span>
            </div>
            <div class="context-card">
              <span class="context-label">\u{1F465} Grouping</span>
              <span class="context-value">None (single cohort)</span>
            </div>
          </div>
          
          <div class="scenario-insights">
            <strong>\u{1F4A1} Strategic Questions:</strong>
            <ul>
              <li>What is the overall sentiment balance? Is the rollout perceived as successful?</li>
              <li>What specific pain points drive negative feedback (bugs, timeouts, waitlist confusion)?</li>
              <li>Are there \u201Cquick wins\u201D mentioned by positive posters that could be highlighted in communications?</li>
              <li>How would you summarize this for stakeholders deciding whether to accelerate fixes vs. celebrate wins?</li>
            </ul>
          </div>
          
          <p><strong>How to Use:</strong> Click <em>Load Scenario</em> to populate the dataset. Run the analysis to see the sentiment distribution. Examine the token-level examples to understand what words drive positive vs. negative scores. Use results to draft a stakeholder briefing.</p>
        </div>
      </div>
    `,
    dataset: 'enrollment_reddit_posts.csv',
    textColumn: 'text'
  },
  {
    id: 'influencer-swimwear',
    label: '\u{1F459} Influencer Swimwear Brand: Customer Reviews',
    description: () => `
      <div class="scenario-card">
        <div class="scenario-header">
          <span class="scenario-icon">\u{1F459}</span>
          <h3>Influencer Swimwear Brand: Customer Review Analysis</h3>
        </div>
        <div class="scenario-badge-row">
          <span class="badge badge-context">E-commerce Reviews</span>
          <span class="badge badge-hypothesis">Brand Launch Assessment</span>
          <span class="badge badge-sample">n = 25 reviews</span>
        </div>
        <div class="scenario-body">
          <p><strong>Business Context:</strong> A popular lifestyle influencer with 2M+ followers launched a <strong>direct-to-consumer swimwear line</strong>. Early reviews are streaming in on the brand\u2019s website. Marketing needs to understand customer reception before a planned summer campaign expansion. Initial signals are positive overall\u2014customers love the aesthetic and colors\u2014but nuanced concerns about fit and sizing for different body types are emerging.</p>
          
          <div class="context-grid">
            <div class="context-card">
              <span class="context-label">\u{1F4DD} Text Column</span>
              <span class="context-value"><code>text</code> (review content)</span>
            </div>
            <div class="context-card">
              <span class="context-label">\u{1F465} Grouping</span>
              <span class="context-value">None (single brand)</span>
            </div>
          </div>
          ...
          <div class="scenario-insights">
            <strong>\u{1F4A1} Strategic Questions:</strong>
            <ul>
              <li>Can aggregate positive sentiment mask specific, actionable pain points?</li>
              <li>What themes emerge in <em>negative</em> reviews? (sizing inconsistency, fit issues, fabric concerns)</li>
              <li>Are positive reviews specific enough to quote in marketing materials?</li>
              <li>What would you recommend to the product team based on sentiment patterns?</li>
            </ul>
          </div>
          
          <p><strong>Key Themes to Explore:</strong> Design aesthetics, color variety, fit/sizing consistency, fabric quality, value perception, shipping experience.</p>
          
          <p><strong>How to Use:</strong> Load the scenario, run sentiment analysis, and examine both the aggregate statistics and individual review breakdowns. Note how positive compound scores may still contain constructive criticism embedded in otherwise glowing reviews.</p>
        </div>
      </div>
    `,
    dataset: 'influencer_swimwear_reviews.csv',
    textColumn: 'text'
  },
  {
    id: 'waterbottle-competitors',
    label: '\u{1F4A7} Water Bottle Brands: Competitive Sentiment Analysis',
    description: () => `
      <div class="scenario-card">
        <div class="scenario-header">
          <span class="scenario-icon">\u{1F3C6}</span>
          <h3>Water Bottle Brand Competitive Intelligence</h3>
        </div>
        <div class="scenario-badge-row">
          <span class="badge badge-context">Competitive Analysis</span>
          <span class="badge badge-hypothesis">Brand Perception Study</span>
          <span class="badge badge-sample">n = 100 reviews</span>
          <span class="badge badge-regression">Grouped Analysis</span>
        </div>
        <div class="scenario-body">
          <p><strong>Business Context:</strong> A CPG company preparing to launch a <strong>new premium reusable water bottle</strong> commissioned research to understand the competitive landscape. They surveyed 100 current users across three leading brands, asking each to provide a detailed review of their experience. The goal: identify positioning opportunities and potential weaknesses to exploit.</p>
          
          <div class="context-grid">
            <div class="context-card">
              <span class="context-label">\u{1F4DD} Text Column</span>
              <span class="context-value"><code>review</code> (customer feedback)</span>
            </div>
            <div class="context-card">
              <span class="context-label">\u{1F465} Group Column</span>
              <span class="context-value"><code>brand</code> (competitor name)</span>
            </div>
          </div>
          
          <div style="background: #f8fafc; border-radius: 8px; padding: 1rem; margin: 1rem 0;">
            <strong>\u{1F3AF} Brands Compared:</strong>
            <ul style="margin: 0.5rem 0 0 0;">
              <li><strong>HydroFlask</strong> \u2014 Known for vibrant colors and strong insulation claims</li>
              <li><strong>Yeti</strong> \u2014 Premium pricing with rugged, outdoor durability positioning</li>
              <li><strong>Stanley</strong> \u2014 Heritage brand experiencing social media-driven resurgence</li>
            </ul>
          </div>
          ...
          <div class="scenario-insights">
            <strong>\u{1F4A1} Strategic Questions:</strong>
            <ul>
              <li>Which competitor has the strongest positive perception overall?</li>
              <li>Which brand shows the most negative sentiment? What themes drive dissatisfaction?</li>
              <li>Are there common pain points across all brands (opportunity for differentiation)?</li>
              <li>What themes drive sentiment for each brand? (insulation, durability, price, aesthetics)</li>
              <li>How would you position a new entrant based on these competitive insights?</li>
            </ul>
          </div>
          
          <p><strong>How to Use:</strong> Load the scenario, then <strong>enable grouping</strong> by selecting the <code>brand</code> column. Run analysis to see sentiment broken down by competitor. Compare grouped statistics and charts to build a competitive positioning recommendation.</p>
        </div>
      </div>
    `,
    dataset: 'waterbottle_competitors.csv',
    textColumn: 'review',
    groupColumn: 'brand'
  }
];
